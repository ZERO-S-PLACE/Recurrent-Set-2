...
import org.zeros.recurrent_set_2.EquationParser.TwoFactorsCalculation.TwoFactorCalculation;
...
public class TwoFactorsNode implements EquationTreeNode {
    ...
    public Complex getSolution(Map<String, Complex> variables){
        return calculationCommand.calculate(leftChild.getSolution(variables), rightChild.getSolution(variables));
    }
