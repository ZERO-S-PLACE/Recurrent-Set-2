...
public class CharactersValues {
    ...
    public static final Map<String, Complex> CONSTANT_VALUES = Map.of(
            "e", Complex.valueOf(Math.E, 0),
            "i", Complex.valueOf(0, 1),
            "PI", Complex.valueOf(Math.PI, 0));

    public static OneFactorCalculation FUNCTIONS_CALCULATORS(String operator) {
    ...
    public static TwoFactorCalculation OPERATORS_CALCULATORS(String operator) {
        return switch (operator) {
